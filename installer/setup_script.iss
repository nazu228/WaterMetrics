; Inno Setup Script for WaterMetrics Professional Edition v1.3.1
...
OutputBaseFilename=WaterMetrics_Setup_v1.3.1
...
[Files]
Source: "..\dist\WaterMetrics\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
