; Inno Setup Script for WaterMetrics Professional Edition v1.0.23
...
[Setup]
AppId={{8B4A2D45-7E3B-4E38-9B9D-2A62C6E6E101}}
AppName={#MyAppName}
...
AllowNoIcons=yes
OutputDir=..\dist
OutputBaseFilename=WaterMetrics_Setup_v1.0.23
